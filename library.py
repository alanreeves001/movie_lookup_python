...
from db import ConnectToDatabase, CloseDatabaseConnection, ExecuteQuery
...
def GetSettings(db_file):
	...
	query = """
			...
			WHERE 1
			   ...
			   AND delflag = 0
			"""
	settings = ExecuteQuery(conn, query, {"user_id": 0})
	print(settings.fetchall())
